    ...
    <div className="main">
      <div className="main-container">
        ...
        >
          ...
          >
            {(questionData?.answerDetails) !== undefined ? (questionData?.answerDetails.length) : null} Answers
          </p>
          {questionData?.answerDetails !== undefined ? ( questionData?.answerDetails.map((_q) => {
           return <>
              <div
                style={{
